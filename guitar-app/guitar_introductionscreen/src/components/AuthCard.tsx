...
const AuthCard: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Login/register successful, user:', user);
      ...
      >
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <motion.button
            ...
            className="w-full bg-primary-500 hover:bg-primary-600 text-dark-900 font-bold py-3 px-4 rounded-xl flex items-center justify-center gap-2 mt-6 shadow-[0_0_20px_rgba(57,255,20,0.3)] hover:shadow-[0_0_30px_rgba(57,255,20,0.5)] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div className="grid grid-cols-2 gap-4">
          <button className="glass-panel py-3 px-4 rounded-xl flex justify-center items-center gap-2 hover:bg-white/10 transition-colors" disabled>
