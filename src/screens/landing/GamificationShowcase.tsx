    ...
    <div className="relative z-10 py-32 px-4 max-w-6xl mx-auto border-t-2 border-dark-700">
      <div className="flex flex-col md:flex-row items-center gap-16">
        ...
        <div className="md:w-1/2 w-full flex justify-center">
           <div className="w-full max-w-md duo-card duo-card-secondary p-0 overflow-hidden border-b-8">
             ...
             <div className="bg-dark-700/50 p-6 flex justify-between items-center border-b-2 border-dark-700">
               ...
               <span className="text-accent-500 font-bold">12 hrs remaining</span>
             </div>
             ...
             <div className="p-8 space-y-8">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between mb-2">
                        <h5 className="font-extrabold text-white text-lg">Achieve 90% accuracy</h5>
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h2 className="text-5xl md:text-6xl font-black mb-6 leading-tight text-white">
            Gamify your <br/>
            <span className="text-primary-500">guitar practice.</span>
          </h2>
          <p className="text-2xl text-gray-400 mb-10 font-bold max-w-lg">
            Stay motivated with our game-like learning features. Earn XP, complete daily quests, and compete with friends on the leaderboard.
          </p>
        </div>
